...
const youtube = new YouTube("AIzaSyBkaAnizJbnLTfovOMD_m4c8DZiGJ15u1c"); //تعديل اساسي سوي اي بي اي جديد
const hastebins = require("hastebin-gen");
const getYoutubeID = require("get-youtube-id");
const yt_api_key = "AIzaSyBkaAnizJbnLTfovOMD_m4c8DZiGJ15u1c"; ///تعديل اساسي سوي اي بي اي جديد
...
client.on("message", message => {
  if (message.content === prefix + "bot") {
    const bot = new Discord.RichEmbed()
      ...
      .addField("**Bot Owner** :  ", `» <@726409526076506142>`, true) // تعديل اساسي غير الايدي لايدي حسابك
      .setImage("")
  ...
  if (message.content === prefix + "lock") {
    ...
    message.channel
      ...
      var manage = new Discord.RichEmbed()
          .setDescription("تم قفل الشات :white_check_mark:")
          .setColor("RANDOM");
      ...
      .then(msgg => {
        message.channel
          ...
          .then(collected => {
            ...
            if (!room)
              return message.channel.send(
                "**لم استطع ايجاد الروم | اعد المحاوله لاحقا**"
              );
...
client.on("message", message => {
  if (message.content === "-inv") {
    message.channel.send("**هذا البوت بريميوم (مدفوع) يجب عليك شراءة**");
    message.channel.sendFile("");
  }
});
...
var statuss = ["-help","-inv","Bot Demo","75s to verifying"]; // بالإمكان اضافة المزيد بدون التعديل في الكود
var secound = 7; // عدد الثواني المحددة
client.on("ready", () =>{
